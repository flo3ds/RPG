...
public final class ElementOrder<T> {
	...
	@SuppressWarnings("Immutable") // Hopefully the comparator provided is
									// immutable!
	@Nullable
	...
	/**
	 * Returns an instance which specifies that insertion ordering is
	 * guaranteed.
	 */
