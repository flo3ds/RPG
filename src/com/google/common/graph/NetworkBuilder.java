 ...
 * <li>orders {@link Network#nodes()} and {@link Network#edges()} in the order
...
public final class NetworkBuilder<N, E> extends AbstractGraphBuilder<N> {
	...
	/**
	 * Returns a {@link NetworkBuilder} initialized with all properties
	 * queryable from {@code
	 * network}.
	 *
	 * <p>
	 * The "queryable" properties are those that are exposed through the
	 * {@link Network} interface, such as {@link Network#isDirected()}. Other
	...
	/**
	 * Specifies whether the network will allow parallel edges. Attempting to
	 * add a parallel edge to a network that does not allow them will throw an
	...
	/**
	 * Specifies whether the network will allow self-loops (edges that connect a
	 * node to itself). Attempting to add a self-loop to a network that does not
	 ...
	 *
	 * @throws IllegalArgumentException
	 *             if {@code expectedEdgeCount} is negative
	 */
	...
	/**
	 * Returns an empty {@link MutableNetwork} with the properties of this
	 * {@link NetworkBuilder}.
	 */
