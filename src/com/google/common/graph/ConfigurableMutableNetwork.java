 ...
 * {@code removeNode(N node)}, which is in O(d_node) where d_node is the degree
 * of {@code node}.
 *
 * @author James Sexton
...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
	 ...
	 *             if {@code node} is already present
	 */
	@CanIgnoreReturnValue
	...
	public boolean removeNode(N node) {
		...
		// Since views are returned, we need to copy the edges that will be
		// removed.
