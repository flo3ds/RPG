...
/**
 * Implementation of FarmHash Fingerprint64, an open-source fingerprinting
 * algorithm for strings.
 *
 * <p>
 * Its speed is comparable to CityHash64, and its quality of hashing is at least
 * as good.
 *
 * <p>
...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
	...
	/**
	 * Computes intermediate hash of 32 bytes of byte array from the given
	 * offset. Results are returned in the output array because when we last
	 * measured, this was 12% faster than allocating new arrays every time.
	 */
	...
	private static long hashLength65Plus(byte[] bytes, int offset, int length) {
		final int seed = 81;
		// For strings over 64 bytes we loop. Internal state consists of 56
		// bytes: v, w, x, y, and z.
		long x = seed;
