...
public final class Funnels {
	 ...
	 * {@code CharSequence}, a character at a time, without performing any
	 * encoding. If you need to use a specific encoding, use
	...
	/**
	 * Returns a funnel that encodes the characters of a {@code CharSequence}
	 * with the specified {@code Charset}.
	 *
	 * @since 15.0
	 */
	...
	/**
	 * Wraps a {@code PrimitiveSink} as an {@link OutputStream}, so it is easy
	 * to {@link Funnel#funnel funnel} an object to a {@code PrimitiveSink} if
	 * there is already a way to write the contents of the object to an
	 * {@code OutputStream}.
	 *
	 * <p>
	 * The {@code close} and {@code flush} methods of the returned
	 * {@code OutputStream} do nothing, and no method throws
	 * {@code IOException}.
	 *
	 * @since 13.0
	 */
