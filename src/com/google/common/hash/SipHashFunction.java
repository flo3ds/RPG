...
final class SipHashFunction extends AbstractHashFunction implements Serializable {
	...
	/**
	 * @param c
	 *            the number of compression rounds (must be positive)
	 * @param d
	 *            the number of finalization rounds (must be positive)
	 * @param k0
	...
	private static final class SipHasher extends AbstractStreamingHasher {
		...
		// big-endian encoded. There is nothing special about this value; the
		// only requirement
		// was some asymmetry so that the initial v0 and v1 differ from v2 and
		// v3.
		...
		// The final 64-bit chunk includes the last 0 through 7 bytes of m
