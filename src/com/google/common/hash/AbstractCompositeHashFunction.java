...
abstract class AbstractCompositeHashFunction extends AbstractHashFunction {
	 ...
	 * functions. Each of them has consumed the entire input and they are ready
	 * to output a {@code HashCode}. The order of the hashers are the same order
	 * as the functions given to the constructor.
	 */
