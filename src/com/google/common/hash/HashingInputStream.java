...
public final class HashingInputStream extends FilterInputStream {
	...
	/**
	 * Creates an input stream that hashes using the given {@link HashFunction}
	 * and delegates all data read from it to the underlying
	 * {@link InputStream}.
	 *
	 * <p>
	 * The {@link InputStream} should not be read from before or after the
	 * hand-off.
	 */
	...
	/**
	 * Reads the next byte of data from the underlying input stream and updates
	 * the hasher with the byte read.
	 */
	@Override
