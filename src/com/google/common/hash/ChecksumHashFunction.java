...
final class ChecksumHashFunction extends AbstractHashFunction implements Serializable {
	...
	private final class ChecksumHasher extends AbstractByteHasher {
		...
		public HashCode hash() {
			...
			if (bits == 32) {
				/*
				 * The long returned from a 32-bit Checksum will have all 0s for
				 * its second word, so the cast won't lose any information and
				 * is necessary to return a HashCode of the correct size.
				 */
