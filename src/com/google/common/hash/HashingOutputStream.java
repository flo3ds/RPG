...
public final class HashingOutputStream extends FilterOutputStream {
	 ...
	 * {@link HashFunction}, and forwards all data written to it to the
	...
	/**
	 * Returns the {@link HashCode} based on the data written to this stream.
	 * The result is unspecified if this method is called more than once on the
	 * same instance.
	 */
	...
	// has bad behavior:
	// it silently ignores any exception thrown by flush(). Instead, just close
	// the delegate stream.
