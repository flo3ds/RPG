...
public interface Interner<E> {
	/**
	 * Chooses and returns the representative instance for any of a collection
	 * of instances that are equal to each other. If two
	 * {@linkplain Object#equals equal} inputs are given to this method, both
	 * calls will return the same instance. That is, {@code intern(a).equals(a)}
	 * always holds, and {@code
