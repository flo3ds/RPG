...
public interface SortedMultiset<E> extends SortedMultisetBridge<E>, SortedIterable<E> {
	 ...
	 * {@link Ordering#natural()} if the natural ordering of the elements is
	 * used.
	 */
	Comparator<? super E> comparator();

	/**
	 * Returns the entry of the first element in this multiset, or {@code null}
	 * if this multiset is empty.
	 */
	Entry<E> firstEntry();

	/**
	 * Returns the entry of the last element in this multiset, or {@code null}
	 * if this multiset is empty.
	 */
	Entry<E> lastEntry();
	...
	/**
	 * Returns and removes the entry associated with the greatest element in
	 * this multiset, or returns {@code null} if this multiset is empty.
	 */
	 ...
	 *
	 * <p>
	 * The {@code entrySet}'s iterator returns entries in ascending element
	 ...
	 * reflected in the other. The returned multiset supports all operations
	 * that this multiset supports.
	 *
	 * <p>
	 * The returned multiset will throw an {@link IllegalArgumentException} on
	 ...
	 * {@code lowerBound} and {@code upperBound}. The returned multiset is a
	 * view of this multiset, so changes to one will be reflected in the other.
