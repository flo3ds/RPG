...
abstract class AbstractIndexedListIterator<E> extends UnmodifiableListIterator<E> {
	 ...
	 * return {@code position}, and the first call to {@link #next()} will
	 * return the element at that index, if available. Calls to
	 * {@link #previous()} can retrieve the preceding {@code position} elements.
	 *
	 * @throws IndexOutOfBoundsException
	 *             if {@code position} is negative or is greater than
	 *             {@code size}
	 * @throws IllegalArgumentException
	 *             if {@code size} is negative
	 */
