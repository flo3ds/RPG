 ...
 *
 * <p>
 * <b>{@code default} method warning:</b> This class does <i>not</i> forward
 * calls to {@code
 * default} methods. Instead, it inherits their default implementations. When
 * those implementations invoke methods, they invoke methods on the
...
public abstract class ForwardingMultiset<E> extends ForwardingCollection<E> implements Multiset<E> {
	 ...
	 * you override {@link #count}, you may wish to override {@link #contains}
	 ...
	 * {@link #add(Object, int)}. If you override {@link #add(Object, int)}, you
	 ...
	 * {@link #add(Object)} and {@link #add(Object, int)}. If you override
	 ...
	 * {@link #remove(Object, int)}. If you override
	 * {@link #remove(Object, int)}, you may wish to override
	 * {@link #remove(Object)} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	@Override
	 ...
	 * {@link #elementSet}, you may wish to override {@link #removeAll} to
	 ...
	 * {@link #elementSet}, you may wish to override {@link #retainAll} to
	 * forward to this implementation.
	 *
	 * @since 7.0
	 */
	 ...
	 * {@link #count(Object)} and {@link #setCount(Object, int)}. If you
	 * override either of these methods, you may wish to override
	 ...
	 * {@link ForwardingMultiset#contains},
	 * {@link ForwardingMultiset#containsAll}, {@link ForwardingMultiset#count},
	 * {@link ForwardingMultiset#isEmpty}, the {@link Set#size} and
	 * {@link Set#iterator} methods of {@link ForwardingMultiset#entrySet}, and
	 * {@link ForwardingMultiset#remove(Object, int)}. In many situations, you
	 * may wish to override {@link ForwardingMultiset#elementSet} to forward to
	 ...
	 * these methods, you may wish to override {@link #equals} to forward to
	 * this implementation.
	 *
	 * @since 7.0
	 */
	...
	/**
	 * A sensible definition of {@link #hashCode} as
	 * {@code entrySet().hashCode()} . If you override {@link #entrySet}, you
	 * may wish to override {@link #hashCode} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	...
	/**
	 * A sensible definition of {@link #toString} as
	 * {@code entrySet().toString()} . If you override {@link #entrySet}, you
	 * may wish to override {@link #toString} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	@Override
