...
public interface BiMap<K, V> extends Map<K, V> {
	 ...
	 *             if the given value is already bound to a different key in
	 *             this bimap. The bimap will remain unmodified in this event.
	 *             To avoid this exception, call {@link #forcePut} instead.
	 */
	@Override
	 ...
	 *
	 * <p>
	 * <b>Warning:</b> If an existing entry with this value is removed, the key
	 ...
	 *
	 * <p>
	 * <b>Warning:</b> the results of calling this method may vary depending on
	 * the iteration order of {@code map}.
	 *
	 * @throws IllegalArgumentException
	 *             if an attempt to {@code put} any entry fails. Note that some
	 *             map entries may have been added to the bimap before the
	 ...
	 *
	 * <p>
	 * <b>Note:</b>There is no guaranteed correspondence between the iteration
