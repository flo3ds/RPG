...
public interface MapDifference<K, V> {
	...
	/**
	 * Returns an unmodifiable map containing the entries from the left map
	 * whose keys are not present in the right map.
	 */
	Map<K, V> entriesOnlyOnLeft();

	/**
	 * Returns an unmodifiable map containing the entries from the right map
	 * whose keys are not present in the left map.
	 */
	...
	interface ValueDifference<V> {
		 ...
		 * values are equal and their {@link #rightValue()} values are also
		 * equal.
		 */
		@Override
