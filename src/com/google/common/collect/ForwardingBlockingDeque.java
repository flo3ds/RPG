 ...
 * {@code BlockingDeque}. Subclasses should override one or more methods to
 * modify the behavior of the backing deque as desired per the
 ...
 * overriding {@link #add} alone <b>will not</b> change the behaviour of
 * {@link #offer} which can lead to unexpected behaviour. In this case, you
 ...
 *             {@code com.google.common.util.concurrent}. Please use
 *             {@link com.google.common.util.concurrent.ForwardingBlockingDeque}
 *             instead. This class is scheduled for deletion in January 2019.
 */
@Deprecated
@GwtIncompatible
