...
/**
 * A {@link List} whose contents will never change, with many other important
...
public abstract class ImmutableList<E> extends ImmutableCollection<E> implements List<E>, RandomAccess {
	 ...
	 * new {@code ImmutableList}, in encounter order.
	 *
	 * @since 21.0
	 */
	@Beta
	...
	/**
	 * Returns the empty immutable list. This list behaves and performs
	 ...
	 *
	 * <p>
	 * Note that if {@code list} is a {@code List<String>}, then {@code
	...
	public static <E> ImmutableList<E> copyOf(Collection<? extends E> elements) {
		if (elements instanceof ImmutableCollection) {
			@SuppressWarnings("unchecked") // all supported methods are
											// covariant
	...
	/**
	 * Returns an immutable list containing the given elements, sorted according
	 * to their natural order. The sorting algorithm used is stable, so elements
	 * that compare as equal will stay in the order in which they appear in the
	 * input.
	 *
	 * <p>
	 * If your data has no duplicates, or you wish to deduplicate elements, use
	 * {@code
	 * ImmutableSortedSet.copyOf(elements)}; if you want a {@code List} you can
	 * use its {@code
	 * asList()} view.
	 *
	 * <p>
	 * <b>Java 8 users:</b> If you want to convert a
	 * {@link java.util.stream.Stream} to a sorted {@code ImmutableList}, use
	 * {@code stream.sorted().collect(toImmutableList())}.
	 *
	 * @throws NullPointerException
	 *             if any element in the input is null
	 * @since 21.0
	 */
	...
	/**
	 * Returns an immutable list containing the given elements, in sorted order
	 * relative to the specified comparator. The sorting algorithm used is
	 * stable, so elements that compare as equal will stay in the order in which
	 * they appear in the input.
	 *
	 * <p>
	 * If your data has no duplicates, or you wish to deduplicate elements, use
	 * {@code
	 * ImmutableSortedSet.copyOf(comparator, elements)}; if you want a
	 * {@code List} you can use its {@code asList()} view.
	 *
	 * <p>
	 * <b>Java 8 users:</b> If you want to convert a
	 * {@link java.util.stream.Stream} to a sorted {@code ImmutableList}, use
	...
	/**
	 * Views the array as an immutable list. Does not check for nulls; does not
	 * copy.
	 *
	 * <p>
	...
	/**
	 * Views the array as an immutable list. Copies if the specified range does
	 * not cover the complete array. Does not check for nulls.
	 */
	 ...
	 * all the elements of the ones created before it.
	 *
	 * @since 2.0
	 */
