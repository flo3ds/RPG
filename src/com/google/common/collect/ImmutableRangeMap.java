...
/**
 * A {@link RangeMap} whose contents will never change, with many other
...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
	...
	public static final class Builder<K extends Comparable<?>, V> {
		...
		/**
		 * Copies all associations from the specified range map into this
		 * builder.
		 */
		@CanIgnoreReturnValue
		...
		/**
		 * Returns an {@code ImmutableRangeMap} containing the associations
	...
	/**
	 * Guaranteed to throw an exception and leave the {@code RangeMap}
	 * unmodified.
	 *
	...
	public ImmutableMap<Range<K>, V> asDescendingMapOfRanges() {
		...
		RegularImmutableSortedSet<Range<K>> rangeSet = new RegularImmutableSortedSet<Range<K>>(ranges.reverse(),
	...
	/**
	 * This class is used to serialize ImmutableRangeMap instances. Serializes
	 * the {@link #asMapOfRanges()} form.
	 */
