...
final class Serialization {
	 ...
	 * It returns the size of a map serialized by
	...
	/**
	 * Populates a multiset by reading an input stream, as part of
	 * deserialization. See {@link #writeMultiset} for the data format. The
	 * number of distinct elements is determined by a prior call to
	 * {@link #readCount}.
	 */
	 ...
	 * for each distinct key: the key, the number of values for that key, and
	 * the key's values.
	 */
	...
	/**
	 * Populates a multimap by reading an input stream, as part of
	 * deserialization. See {@link #writeMultimap} for the data format. The
	 * number of distinct keys is determined by a prior call to
	 * {@link #readCount}.
	 */
