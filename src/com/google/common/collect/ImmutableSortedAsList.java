...
final class ImmutableSortedAsList<E> extends RegularImmutableAsList<E> implements SortedIterable<E> {
	...
	// TODO(cpovirk): consider manual binary search under GWT to preserve O(log
	// N) lookup
	@Override
	public int indexOf(@Nullable Object target) {
		int index = delegateCollection().indexOf(target);

		// TODO(kevinb): reconsider if it's really worth making feeble attempts
		// at
		// sanity for inconsistent comparators.

		// The equals() check is needed when the comparator isn't compatible
		// with
		// equals().
	...
	@GwtIncompatible // super.subListUnchecked does not exist; inherited subList
						// is valid if slow
	/*
	 * TODO(cpovirk): if we start to override indexOf/lastIndexOf under GWT,
	 * we'll want some way to override subList to return an
	 * ImmutableSortedAsList for better performance. Right now, I'm not sure
	 * there's any performance hit from our failure to override subListUnchecked
	 * under GWT
	 */
	@Override
