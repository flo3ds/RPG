...
public final class EnumMultiset<E extends Enum<E>> extends AbstractMapBasedMultiset<E> {
	...
	/**
	 * Returns a new {@code EnumMultiset} instance containing the given
	 * elements. Unlike {@link EnumMultiset#create(Iterable)}, this method does
	 * not produce an exception on an empty iterable.
	 *
	 * @since 14.0
	 */
	...
	/**
	 * @serialData the {@code Class<E>} for the enum type, the number of
	 *             distinct elements, the first element, its count, the second
