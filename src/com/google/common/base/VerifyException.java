...
public class VerifyException extends RuntimeException {
	...
	/**
	 * Constructs a {@code VerifyException} with the cause {@code cause} and a
	 * message that is {@code null} if {@code cause} is null, and
	 * {@code cause.toString()} otherwise.
	 *
	 * @since 19.0
	 */
	...
	/**
	 * Constructs a {@code VerifyException} with the message {@code message} and
	 * the cause {@code cause}.
	 *
	 * @since 19.0
	 */
