 ...
 *
 * <p>
 * If the precondition is not met, the {@code Preconditions} method throws an
 * unchecked exception of a specified type, which helps the method in which the
 ...
 *
 * <p>
 * Avoid passing message arguments that are expensive to compute; your code will
 * always compute them, even though they usually won't be needed. If you have
 * such arguments, use the conventional if/throw idiom instead.
 *
 * <p>
 * Depending on your message arguments, memory may be allocated for boxing and
 * varargs array creation. However, the methods of this class have a large
 * number of overloads that prevent such allocations in many common cases.
 *
 * <p>
 * The message string is not formatted unless the exception will be thrown, so
 * the cost of the string formatting itself should not be a concern.
 *
 * <p>
 * As with any performance concerns, you should consider profiling your code (in
 * a production environment if possible) before spending a lot of effort on
 * tweaking a particular element.
 *
 ...
 * "https://github.com/google/guava/wiki/ConditionalFailuresExplained">Conditional
 ...
 * <a href="https://github.com/google/guava/wiki/PreconditionsExplained">using
 * {@code
 * Preconditions}</a>.
 *
...
public final class Preconditions {
	 ...
	 */
	public static void checkArgument(boolean b, @Nullable String errorMessageTemplate, @Nullable Object p1,
			@Nullable Object p2, @Nullable Object p3, @Nullable Object p4) {
		if (!b) {
