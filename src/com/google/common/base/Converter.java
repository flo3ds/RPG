 ...
 * mocking framework.
 * <li>Extend this class and implement its {@link #doForward} and
 * {@link #doBackward} methods.
 * <li><b>Java 8 users:</b> you may prefer to pass two lambda expressions or
...
public abstract class Converter<A, B> implements Function<A, B> {
	 ...
	 *
	 * <p>
	 * <b>Note:</b> you should not override this method. It is non-final for
	 * legacy reasons.
	 */
	@CanIgnoreReturnValue
	 ...
	 * This is useful if the function instances already exist, or so that you
	 * can supply lambda expressions. If those circumstances don't apply, you
	 * probably don't need to use this; subclass {@code Converter} and implement
	 * its {@link #doForward} and {@link #doBackward} methods directly.
	 *
	 * <p>
