...
public final class ImmutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B>
	 ...
	 * 	&#64;code
	 *
	 * 	static final ImmutableTypeToInstanceMap<Handler<?>> HANDLERS = ImmutableTypeToInstanceMap
	 * 			.<Handler<?>>builder().put(new TypeToken<Handler<Foo>>() {
	 * 			}, new FooHandler()).put(new TypeToken<Handler<Bar>>() {
	 * 			}, new SubBarHandler()).build();
	 * }
	 * </pre>
	 *
	 * <p>
	 ...
	 * superset of any map generated before it.
	 *
	 * @since 13.0
	 */
	@Beta
