...
public abstract class AbstractInvocationHandler implements InvocationHandler {
	...
	/**
	 * {@link #invoke} delegates to this method upon any method invocation on
	 * the proxy instance, except {@link Object#equals}, {@link Object#hashCode}
	 * and {@link Object#toString}. The result will be returned as the proxied
	 * method's return value.
	 *
	 * <p>
	 * Unlike {@link #invoke}, {@code args} will never be null. When the method
	 * has no parameter, an empty array is passed in.
	 */
	protected abstract Object handleInvocation(Object proxy, Method method, Object[] args) throws Throwable;

	/**
	 * By default delegates to {@link Object#equals} so instances are only equal
	 * if they are identical. {@code proxy.equals(argument)} returns true if:
	 *
	 * <ul>
	 * <li>{@code proxy} and {@code argument} are of the same type
	 ...
	 * {@code hashCode()} will delegate to this method. Subclasses can override
	 * this method to provide custom equality.
	 */
	@Override
	public int hashCode() {
	 ...
	 * {@code toString()} will delegate to this method. Subclasses can override
	 * this method to provide custom string representation for the proxies.
	 */
	@Override
	...
	private static boolean isProxyOfSameInterfaces(Object arg, Class<?> proxyClass) {
		return proxyClass.isInstance(arg)
				...
				// Under some edge cases (such as the proxy of JDK types
				// serialized and then deserialized)
				// the proxy type may not be the same.
				// We first check isProxyClass() so that the common case of
				// comparing with non-proxy objects
				// is efficient.
