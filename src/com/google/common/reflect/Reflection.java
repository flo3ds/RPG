...
public final class Reflection {
	 ...
	 * Specification (section 6.7). Unlike {@link Class#getPackage}, this method
	 * only parses the class name, without attempting to define the
	 ...
	 * {@code interfaceType} will be used to define the proxy class. To
	 * implement multiple interfaces or specify a class loader, use
	 * {@link Proxy#newProxyInstance}.
	 *
	 * @throws IllegalArgumentException
	 *             if {@code interfaceType} does not specify the type of a Java
	 *             interface
	 */
