...
public final class HostAndPort implements Serializable {
	 ...
	 *             if {@code host} contains a port number, or {@code port} is
	 *             out of range.
	 */
	 ...
	 *
	 * @param host
	 *            the host-only string to parse. Must not contain a port number.
	 * @return if parsing was successful, a populated HostAndPort object.
	 * @throws IllegalArgumentException
	 ...
	 * to increase the strictness of the parser, and disallow IPv6 literals that
