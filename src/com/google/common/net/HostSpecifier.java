...
/**
 * A syntactically valid host specifier, suitable for use in a URI. This may be
 * either a numeric IP address in IPv4 or IPv6 notation, or a domain name.
 *
 * <p>
 ...
 * {@link InetAddresses} to obtain and manipulate a {@link java.net.InetAddress}
 * instance from it rather than using this class. Similarly, if you know that a
 * given string represents a domain name, use {@link InternetDomainName} rather
 * than this class.
 *
 * @author Craig Berry
 * @since 5.0
...
public final class HostSpecifier {
	...
	/**
	 * Returns a {@code HostSpecifier} built from the provided
	 * {@code specifier}, which is already known to be valid. If the
	 * {@code specifier} might be invalid, use {@link #from(String)} instead.
	 *
	 * <p>
	 ...
	 * {@link #fromValid(String)} for a specifier that is not already known to
	 * be valid.
	 *
	 ...
	 * inclusion in a URI. If the host specifier is a domain name, the string
	 * will be normalized to all lower case. If the specifier was an IPv6
	 * address without brackets, brackets are added so that the result will be
