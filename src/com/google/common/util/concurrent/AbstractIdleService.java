 ...
 * need one during startup and shutdown. Subclasses can implement
 * {@link #startUp} and {@link #shutDown} methods, each which run in a executor
 * which by default uses a separate thread for each method.
 *
