...
/**
 * Utilities for treating interruptible operations as uninterruptible. In all
 * cases, if a thread is interrupted during such a call, the call continues to
...
public final class Uninterruptibles {
	...
	/**
	 * Invokes {@code latch.}{@link CountDownLatch#await(long, TimeUnit)
	 ...
	 * <li>To treat {@link InterruptedException} uniformly with other
	 * exceptions, use {@link Futures#getChecked(Future, Class)
	 * Futures.getChecked}.
	...
	/**
	 * Invokes {@code future.}{@link Future#get(long, TimeUnit) get(timeout,
	 ...
	 * {@link Futures#getDone Futures.getDone}.
	 * <li>To treat {@link InterruptedException} uniformly with other
	 * exceptions, use {@link Futures#getChecked(Future, Class, long, TimeUnit)
	 * Futures.getChecked}.
	 * <li>To get uninterruptibility and remove checked exceptions, use
	 * {@link Futures#getUnchecked}.
	 * </ul>
	...
	/**
	 * Invokes
	 * {@code semaphore.}{@link Semaphore#tryAcquire(int, long, TimeUnit)
