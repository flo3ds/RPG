...
public interface ListeningExecutorService extends ExecutorService {
	 ...
	 * instances. The easiest way to obtain a {@code List<ListenableFuture<T>>}
	 * from this method is an unchecked (but safe) cast:
	 * 
	 * <pre>
	 ...
	 *         tasks, in the same sequential order as produced by the iterator
	 *         for the given task list, each of which has completed.
	 * @throws RejectedExecutionException
	 *             {@inheritDoc}
	 ...
	 * @return a list of {@code ListenableFuture} instances representing the
	 *         tasks, in the same sequential order as produced by the iterator
	 *         for the given task list. If the operation did not time out, each
	 *         task will have completed. If it did time out, some of these tasks
