...
public final class CharStreams {
	...
	/**
	 * Reads all characters from a {@link Readable} object into a
	 * {@link String}. Does not close the {@code Readable}.
	 *
	 * @param r
	 *            the object to read from
	 ...
	 * returns {@code false} or all lines have been read and returning the
	 * result produced by the processor. Does not close {@code readable}. Note
	 * that this method may not fully consume the contents of {@code readable}
	...
	/**
	 * Reads and discards data from the given {@code Readable} until the end of
	 * the stream is reached. Returns the total number of chars read. Does not
	 * close the stream.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * Discards {@code n} characters of data from the reader. This method will
	 * block until the full amount has been skipped. Does not close the reader.
	 *
	 * @param reader
	 ...
	 * @throws EOFException
	 *             if this stream reaches the end before skipping all the
	 *             characters
	 * @throws IOException
	 *             if an I/O error occurs
	 */
	 ...
	 * target. Closing the writer will close the target if it is
	 * {@link Closeable}, and flushing the writer will flush the target if it is
