...
public final class Ints {
	 ...
	 *
	 * @param value
	 *            the {@code int} value to constrain
	 * @param min
	 ...
	 * array; equivalent to
	 * {@code ByteBuffer.allocate(4).putInt(value).array()}. For example, the
	 * input value {@code 0x12131415} would yield the byte array {@code {0x12,
	 * 0x13, 0x14, 0x15}}.
	 *
	 * <p>
	 ...
	 * integers using {@link Integer#decode} and {@link Integer#toString()}. The
	 * returned converter throws {@link NumberFormatException} if the input
	 * string is invalid.
	 *
	 * <p>
	 * <b>Warning:</b> please see {@link Integer#decode} to understand exactly
	 * how strings are parsed. For example, the string {@code "0123"} is treated
	 * as <i>octal</i> and converted to the value {@code 83}.
	 *
	 * @since 16.0
	 */
	@Beta
	...
	/**
	 * Returns a comparator that compares two {@code int} arrays <a href=
	 * "http://en.wikipedia.org/wiki/Lexicographical_order">lexicographically</a>.
	 * That is, it compares, using {@link #compare(int, int)}), the first pair
	 ...
	 * instead of throwing an exception if parsing fails. Additionally, this
	 * method only accepts ASCII digits, and returns {@code null} if non-ASCII
	 ...
	 * @return the integer value represented by {@code string}, or {@code null}
	 *         if {@code string} has a length of zero or cannot be parsed as an
	 *         integer value
	 * @since 11.0
	 */
	@Beta
	 ...
	 *         {@code radix}, or {@code null} if {@code string} has a length of
	 *         zero or cannot be parsed as an integer value
	 * @throws IllegalArgumentException
	 *             if {@code radix < Character.MIN_RADIX} or
