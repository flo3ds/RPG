 ...
 *
 * <p>
 * Like other {@code Map.Entry} instances associated with {@code CacheBuilder},
 * this class holds strong references to the key and value, regardless of the
 * type of references the cache may be using.
 *
 * @author Charles Fry
 * @since 10.0
 */
...
public final class RemovalNotification<K, V> extends SimpleImmutableEntry<K, V> {
	...
	/**
	 * Creates a new {@code RemovalNotification} for the given
	 * {@code key}/{@code value} pair, with the given {@code cause} for the
	 * removal. The {@code key} and/or {@code value} may be {@code null} if they
	 ...
	 * (the cause is neither {@link RemovalCause#EXPLICIT} nor
