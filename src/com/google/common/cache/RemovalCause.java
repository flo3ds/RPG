...
public enum RemovalCause {
	/**
	 * The entry was manually removed by the user. This can result from the user
	 * invoking {@link Cache#invalidate}, {@link Cache#invalidateAll(Iterable)},
	 * {@link Cache#invalidateAll()}, {@link Map#remove},
	 * {@link ConcurrentMap#remove}, or {@link Iterator#remove}.
	 */
	EXPLICIT {
		@Override
		boolean wasEvicted() {
	 ...
	 * the user. This can result from the user invoking {@link Cache#put},
	 ...
	 * garbage-collected. This can occur when using
	 * {@link CacheBuilder#weakKeys}, {@link CacheBuilder#weakValues}, or
	 ...
	 * (the cause is neither {@link #EXPLICIT} nor {@link #REPLACED}).
	 */
