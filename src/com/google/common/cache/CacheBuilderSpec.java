 ...
 *
 * <p>
 * {@code CacheBuilderSpec} supports parsing configuration off of a string,
 ...
 * {@link CacheBuilder#initialCapacity}.
 ...
 * {@link CacheBuilder#expireAfterAccess}.
 * <li>{@code expireAfterWrite=[duration]}: sets
 * {@link CacheBuilder#expireAfterWrite}.
 ...
 *
 * <p>
 * The set of supported keys will grow as {@code CacheBuilder} evolves, but
 * existing keys will never be removed.
 *
 * <p>
 * Durations are represented by an integer, followed by one of "d", "h", "m", or
 * "s", representing days, hours, minutes, or seconds respectively. (There is
 * currently no syntax to request expiration in milliseconds, microseconds, or
 * nanoseconds.)
 *
 * <p>
 * Whitespace before and after commas and equal signs is ignored. Keys may not
 * be repeated; it is also illegal to use the following pairs of keys in a
 * single value:
 * <ul>
 ...
 *
 * <p>
 * {@code CacheBuilderSpec} does not support configuring {@code CacheBuilder}
 * methods with non-value parameters. These must be configured in code.
 *
 * <p>
 * A new {@code CacheBuilder} can be instantiated from a
 * {@code CacheBuilderSpec} using {@link CacheBuilder#from(CacheBuilderSpec)} or
...
public final class CacheBuilderSpec {
	 ...
	 *
	 * @param cacheBuilderSpecification
	 *            the string form
	 */
	...
	/**
	 * Returns a CacheBuilder configured according to this instance's
	 * specification.
	 */
	 ...
	 * {@code CacheBuilderSpec} equal to this instance.
	 */
	...
	/**
	 * Returns a string representation for this CacheBuilderSpec instance. The
	...
	/**
	 * Converts an expiration duration/unit pair into a single Long for hashing
	 * and equality. Uses nanos to match CacheBuilder implementation.
	 */
	@Nullable
