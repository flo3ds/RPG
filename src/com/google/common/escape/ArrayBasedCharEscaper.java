...
public abstract class ArrayBasedCharEscaper extends CharEscaper {
	...
	/**
	 * Creates a new ArrayBasedCharEscaper instance with the given replacement
	 * map and specified safe range. If {@code safeMax < safeMin} then no
	 ...
	 * @param safeMin
	 *            the lowest character value in the safe range
	 * @param safeMax
	 ...
	 * Creates a new ArrayBasedCharEscaper instance with the given replacement
	 * map and specified safe range. If {@code safeMax < safeMin} then no
	 * characters are considered safe. This initializer is useful when explicit
	 ...
	 *
	 * @param escaperMap
	 *            the mapping of characters to be escaped
	 * @param safeMin
	 *            the lowest character value in the safe range
	 * @param safeMax
	 *            the highest character value in the safe range
	...
	protected ArrayBasedCharEscaper(ArrayBasedEscaperMap escaperMap, char safeMin, char safeMax) {
		...
		if (safeMax < safeMin) {
			// If the safe range is empty, set the range limits to opposite
			// extremes
			// to ensure the first test of either value will (almost certainly)
			// fail.
