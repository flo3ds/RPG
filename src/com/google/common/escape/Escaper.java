 ...
 * {@link com.google.common.html.HtmlEscapers} and
 * {@link com.google.common.xml.XmlEscapers}. To create your own escapers, use
 * {@link CharEscaperBuilder}, or extend {@code CharEscaper} or
 * {@code UnicodeEscaper}.
 *
...
public abstract class Escaper {
	 ...
	 * not verify the input for well formed characters. A {@code CharEscaper}
	 * should not be used in situations where input is not guaranteed to be
	 * restricted to the Basic Multilingual Plane (BMP).
	 * </ul>
	 *
	 * @param string
