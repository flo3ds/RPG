...
public class MultiBackgroundInitializer
	 ...
	 *
	 * @param exec
	 *            the {@code ExecutorService} for executing the background tasks
	 */
	...
	public static class MultiBackgroundInitializerResults {
		 ...
		 *
		 * @param inits
		 *            the {@code BackgroundInitializer} objects
		 * @param results
		 *            the result objects
		 * @param excepts
		 *            the exceptions
		 */
		private MultiBackgroundInitializerResults(final Map<String, BackgroundInitializer<?>> inits,
		 ...
		 *
		 * @param name
		 *            the name of the {@code BackgroundInitializer}
