 ...
 * class. It follows the rules laid out in the book <a href=
 ...
 *
 * <p>
 * The {@link HashCodeExclude} annotation can be used to exclude fields from
 * being used by the <code>reflectionHashCode</code> methods.
 * </p>
 *
 * @since 1.0
 */
public class HashCodeBuilder implements Builder<Integer> {
	...
	private static void reflectionAppend(final Object object, final Class<?> clazz, final HashCodeBuilder builder,
			final boolean useTransients, final String[] excludeFields) {
	 ...
	 *            a non-zero, odd number used as the initial value. This will be
	 *            the returned value if no fields are found to include in the
	 *            hash code
	...
	public static <T> int reflectionHashCode(final int initialNonZeroOddNumber, final int multiplierNonZeroOddNumber,
			final T object, final boolean testTransients, final Class<? super T> reflectUpToClass,
	 ...
	 * the likelihood of bugs in mis-calling toHashCode() and the unlikeliness
