...
public class CharSetUtils {
	 ...
	 * {@code CharSetUtils.evaluateSet(null);}.
	 * </p>
	 *
	 * <p>
	...
	/**
	 * <p>
	 * Takes an argument in set-syntax, see evaluateSet, and identifies whether
	 * any of the characters are present in the specified string.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @see CharSet#getInstance(java.lang.String...) for set-syntax.
	 * @param str
	 *            String to look for characters in, may be null
	 * @param set
	 *            String[] set of characters to identify, may be null
	 ...
	 *
	 * @param strings
	 *            String[] whose elements are being checked for emptiness
