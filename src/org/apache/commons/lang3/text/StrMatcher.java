 ...
 *             "https://commons.apache.org/proper/commons-text/javadocs/api-release/org/apache/commons/text/StrMatcher.html">
...
public abstract class StrMatcher {
	 ...
	 * characters preceding <code>pos</code> as well as those after, so long as
	 ...
	 * <p>
	 * The matching code may check one character or many. It may check
	 * characters preceding <code>pos</code> as well as those after.
	 * <p>
	 * It must return zero for no match, or a positive number if a match was
	 * found. The number indicates the number of characters that matched.
	 *
