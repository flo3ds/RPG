 ...
 * <li>toCharArray/getChars - simpler ways to get a range of the character
 * array</li>
 ...
 *             "https://commons.apache.org/proper/commons-text/javadocs/api-release/org/apache/commons/text/StrBuilder.html">
...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
	...
	// -----------------------------------------------------------------------
	/**
	 * If possible, reads chars from the provided {@link Readable} directly into
	...
	/**
	 * Appends a CharSequence to this string builder. Appending null will call
	 * {@link #appendNull()}.
	 *
	 * @param seq
	...
	/**
	 * Appends part of a CharSequence to this string builder. Appending null
	...
	/**
	 * Appends the contents of a char buffer to this string builder. Appending
	...
	/**
	 * Appends a StringBuilder to this string builder. Appending null will call
	 * {@link #appendNull()}.
	 *
	 * @param str
	...
	/**
	 * Appends part of a StringBuilder to this string builder. Appending null
	 * will call {@link #appendNull()}.
	 *
	 * @param str
	 *            the StringBuilder to append
	...
	public <T> StrBuilder appendAll(@SuppressWarnings("unchecked") final T... array) {
		 ...
		 * use @SafeVarargs, since this method is not final.
		 * Using @SupressWarnings is fine, because it isn't inherited by
		 * subclasses, so each subclass must vouch for itself whether its use of
		 * 'array' is safe.
		 */
	 ...
	 * Appending a null iterable will have no effect. Each object is appended
	...
	/**
	 * Appends an iterable placing separators between each value, but not before
	 * the first or after the last. Appending a null iterable will have no
	 ...
	 * you could write a matcher to delete all occurrences where the character
	 ...
	 * you could write a matcher to replace all occurrences where the character
	 * 'a' is followed by a number.
	 *
	 * @param matcher
	 *            the matcher to use to find the deletion, null causes no action
	 ...
	 * write a matcher to delete all occurrences where the character 'a' is
	...
	/**
	 * Appends current contents of this <code>StrBuilder</code> to the provided
	 * {@link Appendable}.
	 * <p>
	...
	/**
	 * Gets a StringBuilder version of the string builder, creating a new
	 * instance each time the method is called.
	 *
