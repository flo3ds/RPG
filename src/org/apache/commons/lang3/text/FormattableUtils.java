...
public class FormattableUtils {
	 ...
	 * programming. Instead, the methods of the class should be invoked
	 * statically.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * @param formattable
	 *            the instance to convert to a string, not null
	 ...
	 *
	 * @param seq
	 *            the string to handle, not null
	 * @param formatter
	 *            the destination formatter, not null
	 * @param flags
	 *            the flags for formatting, see {@code Formattable}
	 * @param width
	 *            the width of the output, see {@code Formattable}
	 * @param precision
	 *            the precision of the output, see {@code Formattable}
	 ...
	 *            the precision of the output, see {@code Formattable}
	 * @param ellipsis
	 *            the ellipsis to use when precision dictates truncation, null
