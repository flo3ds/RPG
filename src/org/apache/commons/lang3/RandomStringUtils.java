...
public class RandomStringUtils {
	 ...
	 *
	 * <p>
	 * Characters will be chosen from the set of Latin alphabetic characters
	 * (a-z, A-Z).
	 * </p>
	 *
	 * @param count
	 ...
	 *
	 * <p>
	 * Characters will be chosen from the set of characters which match the
	 * POSIX [:graph:] regular expression character class. This class contains
	 * all visible ASCII characters (i.e. anything except spaces and control
	 * characters).
	 * </p>
	 *
	 * @param count
	 ...
	 * <p>
	 * Characters will be chosen from the set of characters which match the
	 * POSIX [:print:] regular expression character class. This class includes
	 * all visible ASCII characters and spaces (i.e. anything except control
	 * characters).
	 * </p>
	 *
	 * @param count
	 ...
	 *            the length of random string to create
	 * @param letters
	 *            if {@code true}, generated string may include alphabetic
	 *            characters
	 * @param numbers
	 *            if {@code true}, generated string may include numeric
	 *            characters
	 * @return the random string
	 */
	 ...
	 * are set to {@code 0} and {@link Character#MAX_CODE_POINT}.
	 *
	 * <p>
	 ...
	 * @param end
	 *            the position in set of chars to end before (exclusive)
	 * @param letters
	 *            only allow letters?
	 * @param numbers
	 *            only allow numbers?
