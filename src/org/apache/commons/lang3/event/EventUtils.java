...
public class EventUtils {
	 ...
	 *             if the object doesn't support the listener type
	 */
	 ...
	 * @param listenerType
	 *            the listener interface (ActionListener.class,
	 *            SelectionListener.class, etc.)
	 * @param eventTypes
	 *            the event types (method names) from the listener interface (if
	 *            none specified, all will be supported)
	 */
	...
	private static class EventBindingInvocationHandler implements InvocationHandler {
		 ...
		 *
		 * @param target
		 *            the target object for method invocations
		 * @param methodName
