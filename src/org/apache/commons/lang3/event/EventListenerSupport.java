...
public class EventListenerSupport<L> implements Serializable {
	 ...
	 *
	 * @param <T>
	 *            the type of the listener interface
	 ...
	 *
	 * @throws NullPointerException
	 *             if <code>listenerInterface</code> or <code>classLoader</code>
	 *             is <code>null</code>.
	 * @throws IllegalArgumentException
	 *             if <code>listenerInterface</code> is not an interface.
	 */
	...
	/**
	 * Create a new EventListenerSupport instance. Serialization-friendly
	 * constructor.
	 */
	 ...
	 *
	 * @param listener
	 *            the event listener (may not be <code>null</code>).
	 *
	 * @throws NullPointerException
	...
	/**
	 * Registers an event listener. Will not add a pre-existing listener object
	 * to the list if <code>allowDuplicate</code> is false.
	 *
	 * @param listener
	 *            the event listener (may not be <code>null</code>).
	 * @param allowDuplicate
	 *            the flag for determining if duplicate listener objects are
	...
	private void createProxy(final Class<L> listenerInterface, final ClassLoader classLoader) {
		proxy = listenerInterface.cast(
				Proxy.newProxyInstance(classLoader, new Class[] { listenerInterface }, createInvocationHandler()));
	}
