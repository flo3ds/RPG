...
public class ClassPathUtils {
	 ...
	 *
	 * <p>
	 * Note that this method does not check whether the resource actually
	 * exists. It only constructs the name. Null inputs are not allowed.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @param resourceName
	 *            the resource name to construct the fully qualified name for.
	 * @return the fully qualified name of the resource with name
	 *         {@code resourceName}.
	 * @throws java.lang.NullPointerException
	 *             if either {@code context} or {@code resourceName} is null.
	 */
	 ...
	 * <p>
	 * Note that this method does not check whether the resource actually
	 * exists. It only constructs the path. Null inputs are not allowed.
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * @param context
	 *            The context for constructing the path.
	 * @param resourceName
	 *            the resource name to construct the fully qualified path for.
