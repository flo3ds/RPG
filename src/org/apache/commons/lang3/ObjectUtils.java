...
public class ObjectUtils {
	...
	/**
	 * <p>
	 * Singleton used as a {@code null} placeholder where {@code null} has
	 * another meaning.
	 * </p>
	 *
	 * <p>
	 ...
	 * {@code null} if the {@code Map} contains {@code null} or if there is no
	 * matching key. The {@code Null} placeholder can be used to distinguish
	 * between these two cases.
	 * </p>
	 *
	 * <p>
	 * Another example is {@code Hashtable}, where {@code null} cannot be
	 * stored.
	 * </p>
	 *
	 * <p>
	 ...
	 * programming. Instead, the static methods on the class should be used,
	 * such as {@code ObjectUtils.defaultIfNull("a","b");}.
	 * </p>
	 *
	 * <p>
	...
	/**
	 * <p>
	 * Returns the first value in the array which is not {@code null}. If all
	 * the values are {@code null} or the array is {@code null} or empty then
	 ...
	 * then {@code false} is returned. Otherwise {@code true} is returned.
	 * </p>
	 *
	 * <pre>
	 ...
	 *         array, {@code false} if all values in the array are
	 *         {@code null}s. If the array is {@code null} or empty
	 *         {@code false} is also returned.
	 * @since 3.5
	 */
	 ...
	 * {@code false} is returned. If all elements in array are not {@code null}
	 * or the array is empty (contains no elements) {@code true} is returned.
	 * </p>
	 *
	 * <pre>
	 ...
	 *         array or the array is {@code null}, {@code true} if all values in
	 *         the array are not {@code null}s or array contains no elements.
	 * @since 3.5
	 */
	 ...
	 *             {@code java.util.Objects.equals(Object, Object)} in Java 7
	 ...
	 * @since 2.1
	 * @deprecated this method has been replaced by
	 *             {@code java.util.Objects.hashCode(Object)} in Java 7 and will
	 ...
	 * The hash code for a single object is the <em>not</em> same as
	 * {@link #hashCode(Object)}. The hash code for multiple objects is the same
	 * as that calculated by an {@code ArrayList} containing the specified
	 * objects.
	 * </p>
	 *
	 * <pre>
	 ...
	 *
	 * @param objects
	 *            the objects to obtain the hash code of, may be {@code null}
	 * @return the hash code of the objects, or zero if null
	 * @since 3.0
	 * @deprecated this method has been replaced by
	 *             {@code java.util.Objects.hash(Object...)} in Java 7 and will
	 *             be removed in future releases.
	 */
	@Deprecated
	 ...
	 *            the object to create a toString for
	 * @since 3.2
	 * @deprecated as of 3.6, because StrBuilder was moved to commons-text, use
	 ...
	 * @since 2.0
	 * @deprecated this method has been replaced by
	 *             {@code java.util.Objects.toString(Object)} in Java 7 and will
	 *             be removed in future releases. Note however that said method
	 *             will return "null" for null references, while this method
	 *             returns an empty String. To preserve behavior use
	 ...
	 * @since 2.0
	 * @deprecated this method has been replaced by
	 *             {@code java.util.Objects.toString(Object, String)} in Java 7
	 ...
	 * @return a negative value if c1 &lt; c2, zero if c1 = c2 and a positive
	 *         value if c1 &gt; c2
	 */
	 ...
	 *            the second comparable, may be null
	 * @param nullGreater
	 *            if true {@code null} is considered greater than a
	 *            non-{@code null} value or if false {@code null} is considered
	 *            less than a Non-{@code null} value
	 * @return a negative value if c1 &lt; c2, zero if c1 = c2 and a positive
	 *         value if c1 &gt; c2
	 ...
	 * provided instance as the return value instead of {@code null} if the
	 * instance is not cloneable. This is more convenient if the caller uses
	 * different implementations (e.g. of a service) and some of the
	 * implementations do not allow concurrent processing or have state. In such
	 * cases the implementation can simply provide a proper clone implementation
	 * and the caller's code does not have to change.
	 * </p>
	 *
	 * @param <T>
	 *            the type of the object
	 ...
	 * 
	 * Should a different jar file refer to this, and the MAGIC_NUMBER is
	 * changed a later date (e.g., MAGIC_NUMBER = 6), the different jar file
	 * will need to recompile itself. This is because javac typically inlines
	 * the primitive or String constant directly into the bytecode, and removes
	 * the reference to the MAGIC_NUMBER field.
	 * 
	 * To help the other jar (so that it does not need to recompile when
	 * constants are changed) the original developer can declare their constant
	 * using one of the CONST() utility methods, instead:
	 * 
	 * public final static int MAGIC_NUMBER = CONST(5);
	 */

	/**
	 * This method returns the provided value unchanged. This can prevent javac
	 * from inlining a constant field, e.g.,
	 *
	 * <pre>
	 ...
	 * @throws IllegalArgumentException
	 *             if the value passed to v is larger than a byte, that is,
	 ...
	 * @throws IllegalArgumentException
	 *             if the value passed to v is larger than a short, that is,
