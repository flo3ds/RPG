...
public class FieldUtils {
	...
	/**
	 * {@link FieldUtils} instances should NOT be constructed in standard
	 * programming.
	 * <p>
	 * This constructor is {@code public} to permit tools that require a
	...
	/**
	 * Gets an accessible {@link Field} by name respecting scope.
	 ...
	 *             if the class is {@code null}, or the field name is blank or
	 *             empty
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             if the class is {@code null}, or the field name is blank or
	 *             empty or is matched at multiple places in the inheritance
	 *             hierarchy
	 */
	...
	/**
	 * Gets an accessible {@link Field} by name respecting scope. Only the
	 ...
	 *            the {@link Class} to query
	 * @param annotationCls
	 *            the {@link Annotation} that must be present on a field to be
	 *            matched
	 * @return an array of Fields (possibly empty).
	 * @throws IllegalArgumentException
	...
	/**
	 * Reads the named {@code public static} {@link Field}. Superclasses will be
	 * considered.
	 *
	 * @param cls
	 *            the {@link Class} to reflect, must not be {@code null}
	...
	/**
	 * Reads the named {@code static} {@link Field}. Superclasses will be
	 * considered.
	 *
	 * @param cls
	 *            the {@link Class} to reflect, must not be {@code null}
	...
	/**
	 * Gets the value of a {@code static} {@link Field} by name. The field must
	 * be {@code public}. Only the specified class will be considered.
	 *
	 * @param cls
	 *            the {@link Class} to reflect, must not be {@code null}
	 * @param fieldName
	...
	/**
	 * Gets the value of a {@code static} {@link Field} by name. Only the
	 * specified class will be considered.
	 *
	 * @param cls
	 *            the {@link Class} to reflect, must not be {@code null}
	 ...
	 *            the field to use
	 * @param target
	 *            the object to call on, may be {@code null} for {@code static}
	 *            fields
	 * @return the field value
	 * @throws IllegalArgumentException
	...
	/**
	 * Reads the named {@code public} {@link Field}. Superclasses will be
	 * considered.
	 *
	 * @param target
	 ...
	 * @return the field value
	 * @throws IllegalArgumentException
	 *             if {@code target} is {@code null}, or the field name is blank
	...
	/**
	 * Reads the named {@code public} {@link Field}. Only the class of the
	...
	/**
	 * Gets a {@link Field} value by name. Only the class of the specified
	 ...
	 *            whether to break scope restrictions using the
	 *            {@link java.lang.reflect.AccessibleObject#setAccessible(boolean)}
	 *            method. {@code false} will only match public fields.
	 * @return the Field object
	 * @throws IllegalArgumentException
	 *             if {@code target} is {@code null}, or the field name is blank
	 *             or empty or could not be found
	 ...
	 *            to set
	 * @throws IllegalArgumentException
	 *             if the field is {@code null} or not {@code static}, or
	...
	/**
	 * Writes a named {@code public static} {@link Field}. Superclasses will be
	 * considered.
	 *
	 * @param cls
	 ...
	 *            to set
	 * @throws IllegalArgumentException
	 *             if {@code cls} is {@code null}, the field name is blank or
	 *             empty, the field cannot be located or is not {@code static},
	...
	/**
	 * Writes a named {@code static} {@link Field}. Superclasses will be
	 * considered.
	 *
	 * @param cls
	 *            {@link Class} on which the field is to be found
	...
	/**
	 * Writes a named {@code public static} {@link Field}. Only the specified
	...
	/**
	 * Writes a named {@code static} {@link Field}. Only the specified class
	 * will be considered.
	 *
	 * @param cls
	 *            {@link Class} on which the field is to be found
	 ...
	 * @param forceAccess
	 *            whether to break scope restrictions using the
	 *            {@code AccessibleObject#setAccessible(boolean)} method.
	 ...
	 *            to set
	 * @throws IllegalAccessException
	 *             if the field or target is {@code null}, the field is not
	 *             accessible or is {@code final}, or {@code value} is not
	 *             assignable
	 */
	 ...
	 *            method. {@code false} will only match {@code public} fields.
	 * @throws IllegalArgumentException
	 *             if the field is {@code null} or {@code value} is not
	 *             assignable
	 * @throws IllegalAccessException
	 *             if the field is not made accessible or is {@code final}
	 */
	...
	public static void removeFinalModifier(final Field field, final boolean forceAccess) {
		...
		try {
			if (Modifier.isFinal(field.getModifiers())) {
				// Do all JREs implement Field with a private ivar called
				// "modifiers"?
	 ...
	 *             or empty or could not be found, or {@code value} is not
	 *             assignable
	 * @throws IllegalAccessException
	 *             if the field is not accessible
	 */
	...
	/**
	 * Writes a {@code public} {@link Field}. Only the specified class will be
	 * considered.
	 *
	 * @param target
	 *            the object to reflect, must not be {@code null}
