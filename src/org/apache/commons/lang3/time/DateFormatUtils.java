...
public class DateFormatUtils {
	...
	/**
	 * @deprecated - as of 4.0, ISO_DATETIME_TIME_ZONE_FORMAT will be replaced
	 *             by ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT.
	 */
	@Deprecated
	 ...
	 *
	 * <p>
	 * The format used is {@code yyyy-MM-dd}. This format uses the default
	 ...
	 * with the formal ISO 8601 specification as the standard does not allow a
	 * time zone without a time. This format uses the default TimeZone in effect
	 * at the time of loading DateFormatUtils class.
	 * </p>
	 *
	...
	/**
	 * Non-compliant formatter for time with time zone (ISO 8601 does not prefix
	...
	/**
	 * @deprecated - as of 4.0, ISO_TIME_NO_T_TIME_ZONE_FORMAT will be replaced
	 *             by ISO_8601_EXTENDED_TIME_TIME_ZONE_FORMAT.
	 */
	@Deprecated
