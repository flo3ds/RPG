...
public class DateUtils {
	...
	/**
	 * <p>
	 * {@code DateUtils} instances should NOT be constructed in standard
	 * programming. Instead, the static methods on the class should be used,
	 * such as {@code DateUtils.parseDate(str);}.
	 * </p>
	 *
	 * <p>
	 ...
	 * 0-23. The original {@code Date} is unchanged.
	 *
	 * @param date
	 *            the date, not null
	 * @param amount
	...
	// -----------------------------------------------------------------------
	/**
	 * Sets the milliseconds field to a date returning a new object. The
	 * original {@code Date} is unchanged.
	 *
	 * @param date
	 *            the date, not null
	...
	// -----------------------------------------------------------------------
	/**
	 * Converts a {@code Date} of a given {@code TimeZone} into a
	 * {@code Calendar}
	 * 
	 * @param date
	 *            the date to convert to a Calendar
	 * @param tz
	 *            the time zone of the {@code date}
	 * @return the created Calendar
	 * @throws NullPointerException
	 *             if {@code date} or {@code tz} is null
	 */
	 ...
	 *
	 * <p>
	 * For example, if you had the date-time of 28 Mar 2002 13:45:01.231, if
	 * this was passed with HOUR, it would return 28 Mar 2002 14:00:00.000. If
	 * this was passed with MONTH, it would return 1 April 2002 0:00:00.000.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * @param date
	 *            the date to work with, either {@code Date} or
	...
	/**
	 * <p>
	 * Truncates a date, leaving the field specified as the most significant
	 * field.
	 * </p>
	 *
	 * <p>
	 * For example, if you had the date-time of 28 Mar 2002 13:45:01.231, if you
	...
	/**
	 * <p>
	 * Constructs an <code>Iterator</code> over each day in a date range defined
	 * by a focus date and range style.
	 * </p>
	 *
	 * <p>
