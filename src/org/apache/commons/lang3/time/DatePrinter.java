...
public interface DatePrinter {
	 ...
	 * The TimeZone specified during the construction of the Parser will
	 * determine the TimeZone used in the formatted string.
	 *
	 * @param calendar
	 ...
	 *            the buffer to format into
	 * @param <B>
	 *            the Appendable class type, usually StringBuilder or
	 *            StringBuffer.
	 * @return the specified string buffer
	 * @since 3.5
	 */
	...
	/**
	 * <p>
	 * Formats a {@code Date} object into the supplied {@code Appendable} using
	 * a {@code GregorianCalendar}.
	 * </p>
	 *
	 * @param date
	 *            the date to format
