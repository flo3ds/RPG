...
public class ArrayUtils {
	 ...
	 *
	 * @param array
	 *            the array to get a hash code for, {@code null} returns zero
	 ...
	 *             {@code java.util.Objects.deepEquals(Object, Object)} and will
	 ...
	 *            the array to reverse, may be {@code null}
	 * @param startIndexInclusive
	 *            the starting index. Under value (&lt;0) is promoted to 0, over
	 *            value (&gt;array.length) results in no change.
	 * @param endIndexExclusive
	 *            elements up to endIndex-1 are reversed in the array. Under
	 *            value (&lt; start index) results in no change. Over value
	 *            (&gt;array.length) is demoted to array length.
	 * @since 3.2
	 */
	 ...
	 * indices. Negative indices are promoted to 0(zero).
	 * </p>
	 *
	 * Examples:
	 * <ul>
	 ...
	 * sub-arrays to swap falls outside of the given array, then the swap is
	 * stopped at the end of the array and as many as possible elements are
	 * swapped.
	 * </p>
	 *
	 * Examples:
	 * <ul>
	 * <li>ArrayUtils.swap([true, false, true, false], 0, 2, 1) -&gt; [true,
	 * false, true, false]</li>
	 * <li>ArrayUtils.swap([true, false, true, false], 0, 0, 1) -&gt; [true,
	 * false, true, false]</li>
	 * <li>ArrayUtils.swap([true, false, true, false], 0, 2, 2) -&gt; [true,
	 * false, true, false]</li>
	 * <li>ArrayUtils.swap([true, false, true, false], -3, 2, 2) -&gt; [true,
	 * false, true, false]</li>
	 * <li>ArrayUtils.swap([true, false, true, false], 0, 3, 3) -&gt; [false,
	 * false, true, true]</li>
	 * </ul>
	 *
	 * @param array
	 ...
	 *            overvalue (&gt;array.length) results in no change.
	 * @param endIndexExclusive
	 *            elements up to endIndex-1 are shifted in the array. Undervalue
	...
	public static void shift(final boolean[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
		...
		// For algorithm explanations and proof of O(n) time complexity and O(1)
		// space complexity
		// see
		// https://beradrian.wordpress.com/2015/04/07/shift-an-array-in-on-in-place/
		while (n > 1 && offset > 0) {
	 ...
	 *
	 * @param array
	 *            the array to traverse backwards looking for the object, may be
	 *            {@code null}
	 * @param objectToFind
	 *            the object to find, may be {@code null}
	 ...
	 * @return an array of the corresponding primitive type, or the original
	 *         array
	 * @since 3.5
	 */
	 ...
	 *             {@link #insert(int, Object[], Object...) insert(int, T[],
	 *             T...)} and may be removed in a future release. Please note
	 *             the handling of {@code null} input arrays differs in the new
	 *             method: inserting {@code X} into a {@code null} array results
	 *             in {@code null} not {@code X}.
	 */
	@Deprecated
	public static <T> T[] add(final T[] array, final int index, final T element) {
		...
		@SuppressWarnings("unchecked") // the add method creates an array of
										// type clss, which is type T
	 ...
	 *             array.length).
	 * @deprecated this method has been superseded by
	 *             {@link #insert(int, boolean[], boolean...)} and may be
	 *             removed in a future release. Please note the handling of
	 *             {@code null} input arrays differs in the new method:
	 *             inserting {@code X} into a {@code null} array results in
	 *             {@code null} not {@code X}.
	 */
	@Deprecated
	 ...
	 *             future release. Please note the handling of {@code null}
	 *             input arrays differs in the new method: inserting {@code X}
	 *             into a {@code null} array results in {@code null} not
	 *             {@code X}.
	 */
	@Deprecated
	 ...
	 *             array.length).
	 * @deprecated this method has been superseded by
	 *             {@link #insert(int, short[], short...)} and may be removed in
	 *             a future release. Please note the handling of {@code null}
	 *             input arrays differs in the new method: inserting {@code X}
	 *             into a {@code null} array results in {@code null} not
	 *             {@code X}.
	 */
	 ...
	 *             array.length).
	 * @deprecated this method has been superseded by
	 *             {@link #insert(int, float[], float...)} and may be removed in
	 *             a future release. Please note the handling of {@code null}
	 *             input arrays differs in the new method: inserting {@code X}
	 *             into a {@code null} array results in {@code null} not
	 *             {@code X}.
	 ...
	 *             array.length).
	 * @deprecated this method has been superseded by
	 *             {@link #insert(int, double[], double...)} and may be removed
	 *             in a future release. Please note the handling of {@code null}
	 *             input arrays differs in the new method: inserting {@code X}
	 *             into a {@code null} array results in {@code null} not
	 *             {@code X}.
	 */
	...
	public static boolean[] removeElements(final boolean[] array, final boolean... values) {
		...
		final HashMap<Boolean, MutableInt> occurrences = new HashMap<>(2); // only
																			// two
																			// possible
																			// values
																			// here
	...
	static Object removeAll(final Object array, final int... indices) {
		final int length = getLength(array);
		int diff = 0; // number of distinct indexes, i.e. number of entries that
						// will be removed
	...
	static Object removeAll(final Object array, final BitSet indices) {
		...
		// No need to check maxIndex here, because method only currently called
		// from removeElements()
	 ...
	 * class's {@code compareTo} method.
	 *
	 * @param array
	 *            the array to check
	 * @param <T>
	 *            the datatype of the array to check, it must implement
	 *            {@code Comparable}
	...
	/**
	 * <p>
	 * This method checks whether the provided array is sorted according to
	 * natural ordering.
	 *
	 * @param array
	 *            the array to check
	 ...
	 * <p>
	 * This method checks whether the provided array is sorted according to
	 * natural ordering ({@code false} before {@code true}).
	 *
	 * @param array
	 *            the array to check
	 * @return whether the array is sorted according to natural ordering
	...
	/**
	 * <p>
	 * Returns an array containing the string representation of each element in
	 * the argument array.
	 * </p>
	 *
	 * <p>
	 ...
	 *         element's string representation, {@code null} if null array input
	 * @throws NullPointerException
	 ...
	 * <p>
	 * Returns an array containing the string representation of each element in
	 * the argument array handling {@code null} elements.
	 * </p>
	 *
	 * <p>
	 * This method returns {@code null} for a {@code null} input array.
	...
	public static <T> T[] insert(final int index, final T[] array, final T... values) {
		...
		final Class<?> type = array.getClass().getComponentType();
		@SuppressWarnings("unchecked") // OK, because array and values are of
										// type T
