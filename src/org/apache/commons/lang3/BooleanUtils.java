...
public class BooleanUtils {
	 ...
	 *
	 * <p>
	 * NOTE: This returns null and will throw a NullPointerException if unboxed
	 * to a boolean.
	 * </p>
	 *
	 * <pre>
	...
	/**
	 * <p>
	 * Checks if a {@code Boolean} value is {@code true}, handling {@code null}
	 ...
	 *            the boolean to convert
	 * @param valueIfNull
	 *            the boolean value to return if {@code null}
	 ...
	 *            the Integer to convert
	 * @param trueValue
	 *            the value to match for {@code true}
	 * @param falseValue
	 *            the value to match for {@code false}
	 * @return {@code true} or {@code false}
	 ...
	 *            the Integer to convert
	 * @param trueValue
	 *            the value to match for {@code true}, may be {@code null}
	 * @param falseValue
	 *            the value to match for {@code false}, may be {@code null}
	 * @return {@code true} or {@code false}
	 * @throws IllegalArgumentException
	 *             if no match
	 */
	 ...
	 *            the value to match for {@code false}
	 * @param nullValue
	 *            the value to to match for {@code null}
	 ...
	 *            the value to match for {@code false}, may be {@code null}
	 * @param nullValue
	 *            the value to to match for {@code null}, may be {@code null}
	 * @return Boolean.TRUE, Boolean.FALSE, or {@code null}
	 * @throws IllegalArgumentException
	 *             if no match
	 */
	...
	/**
	 * <p>
	 * Converts a boolean to an Integer using the convention that {@code zero}
	 * is {@code false}.
	 * </p>
	 *
	 * <pre>
	 ...
	 *            the to convert
	 * @param trueValue
	 *            the value to return if {@code true}
	 * @param falseValue
	 *            the value to return if {@code false}
	 ...
	 *            the value to return if {@code false}
	 * @param nullValue
	 *            the value to return if {@code null}
	 * @return the appropriate value
	 */
	 ...
	 * (case insensitive) will return {@code true}. {@code 'false'},
	 * {@code 'off'}, {@code 'n'}, {@code 'f'} or {@code 'no'} (case
	 * insensitive) will return {@code false}. Otherwise, {@code null} is
	 * returned.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * @param str
	 *            the String to check; upper and lower case are treated as the
	 *            same
	 ...
	 *            the String to check
	 * @param trueString
	 *            the String to match for {@code true} (case sensitive), may be
	 *            {@code null}
	 * @param falseString
	 *            the String to match for {@code false} (case sensitive), may be
	 *            {@code null}
	 * @param nullString
	 *            the String to match for {@code null} (case sensitive), may be
	 *            {@code null}
	 * @return the Boolean value of the string, {@code null} if either the
	 *         String matches {@code nullString} or if {@code null} input and
	 ...
	 * <p>
	 * {@code 'true'}, {@code 'on'}, {@code 'y'}, {@code 't'} or {@code 'yes'}
	 * (case insensitive) will return {@code true}. Otherwise, {@code false} is
	 * returned.
	 * </p>
	 *
	 * <p>
	 * This method performs 4 times faster (JDK1.4) than
	 * {@code Boolean.valueOf(String)}. However, this method accepts 'on' and
	 * 'yes', 't', 'y' as true values.
	 *
	 * <pre>
	 *   BooleanUtils.toBoolean(null)    = false
	...
	/**
	 * <p>
	 * Converts a Boolean to a String returning {@code 'true'}, {@code 'false'},
	 * or {@code null}.
	 * </p>
	 *
	 * <pre>
	...
	/**
	 * <p>
	 * Converts a boolean to a String returning {@code 'true'} or
	 * {@code 'false'}.
	 * </p>
	 *
	 * <pre>
