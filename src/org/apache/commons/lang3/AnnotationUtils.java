...
public class AnnotationUtils {
		...
		protected String getShortClassName(final java.lang.Class<?> cls) {
			...
			for (final Class<?> iface : ClassUtils.getAllInterfaces(cls)) {
				if (Annotation.class.isAssignableFrom(iface)) {
					@SuppressWarnings("unchecked") // OK because we just checked
													// the assignability
	 ...
	 *
	 * @param a1
	 *            the first Annotation to compare, {@code null} returns
	 *            {@code false} unless both are {@code null}
	 * @param a2
	 *            the second Annotation to compare, {@code null} returns
	 *            {@code false} unless both are {@code null}
	 ...
	 *             if an {@code Exception} is encountered during annotation
	 *             member access
	 ...
	 * annotations. These include {@link String}, {@link Class}, primitive
	 * types, {@link Annotation}, {@link Enum}, and single-dimensional arrays of
	 * these types.
	 * </p>
	 *
	 * @param type
	 *            the type to check, {@code null}
