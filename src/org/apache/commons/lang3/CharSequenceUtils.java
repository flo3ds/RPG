...
public class CharSequenceUtils {
	 ...
	 * </pre>
	 * 
	 * </blockquote> is true. For other values of <code>searchChar</code>, it is
	 ...
	 * <code>cs</code> at or after position <code>start</code>, then
	...
	/**
	 * Returns the index within <code>cs</code> of the last occurrence of the
	 * specified character, searching backward starting at the specified index.
	 * For values of <code>searchChar</code> in the range from 0 to 0xFFFF
	 * (inclusive), the index returned is the largest value <i>k</i> such that:
	 * <blockquote>
	 * 
	 * <pre>
	 * (this.charAt(<i>k</i>) == searchChar) &amp;&amp; (<i>k</i> &lt;= start)
	 ...
	 * <code>cs</code> at or before position <code>start</code>, then
	 * <code>-1</code> is returned.
	 *
	 * <p>
	 * All indices are specified in <code>char</code> values (Unicode code
