...
public final class Range<T> implements Serializable {
	...
	/**
	 * <p>
	 * Obtains a range using the specified element as both the minimum and
	 ...
	 *
	 * <p>
	 * The range uses the specified {@code Comparator} to determine where values
	 * lie in the range.
	 * </p>
	 *
	 * @param <T>
	 *            the type of the elements in this range
	 * @param element
	 *            the value to use for this range, must not be {@code null}
	 * @param comparator
	 ...
	 *             if the element is null
	 * @throws ClassCastException
	 *             if using natural ordering and the elements are not
	 *             {@code Comparable}
	 */
	 ...
	 *            the type of the elements in this range
	 * @param fromInclusive
	 *            the first value that defines the edge of the range, inclusive
	 * @param toInclusive
	 ...
	 *
	 * @param element1
	 *            the first element, not null
	 * @param element2
	 *            the second element, not null
	 * @param comp
	 *            the comparator to be used, null for natural ordering
	 */
	...
	/**
	 * <p>
	 * Gets the comparator being used to determine if objects are within the
	 * range.
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * The API is reminiscent of the Comparable interface returning {@code -1}
	 * if the element is before the range, {@code 0} if contained within the
	 * range and {@code 1} if the element is after the range.
	 * </p>
	 *
	 * @param element
	...
	/**
	 * <p>
	 * Checks whether this range contains all the elements of the specified
	 * range.
	 * </p>
	 *
	 * <p>
	 * This method may fail if the ranges have two different comparators or
	 * element types.
	 * </p>
	 *
	 * @param otherRange
	 ...
	 * @param other
	 *            overlapping Range
	 * @return range representing the intersection of {@code this} and
	 *         {@code other} ({@code this} if equal)
	 * @throws IllegalArgumentException
	 ...
	 *
	 * <p>
	 * To be equal, the minimum and maximum values must be equal, which ignores
	 ...
	 * {@code %1$s} for the minimum element, {@code %2$s} for the maximum
	 * element and {@code %3$s} for the comparator. The default format used by
