...
public class Validate {
	...
	/**
	 * <p>
	 * Validate that the argument condition is {@code true}; otherwise throwing
	 ...
	 * <p>
	 * Validate that the argument condition is {@code true}; otherwise throwing
	 * an exception. This method is useful when validating according to an
	 * arbitrary boolean expression, such as validating a primitive number or
	 ...
	 * nor a size of zero (no elements); otherwise throwing an exception with
	...
	/**
	 * <p>
	 * Validate that the specified argument map is neither {@code null} nor a
	 ...
	 * contains any elements that are {@code null}; otherwise throwing an
	 * exception with the specified message.
	 *
	 * <pre>
	 ...
	 *
	 * <p>
	 * If the array is {@code null}, then the message in the exception is
	 ...
	 *
	 * <p>
	 * If the array is {@code null}, then the message of the exception is
	 * &quot;The validated object is null&quot;.
	 * </p>
	 *
	 * @param <T>
	 ...
	 *
	 * <p>
	 * If the character sequence is {@code null}, then the message of the
	...
	/**
	 * <p>
	 * Validate that the stateful condition is {@code true}; otherwise throwing
	 * an exception. This method is useful when validating according to an
	 * arbitrary boolean expression, such as validating a primitive number or
	 * using your own custom validation expression.
	 * </p>
	 ...
	 *            the value to validate
	 * @throws IllegalArgumentException
	 *             if the value is infinite or {@code NaN}
