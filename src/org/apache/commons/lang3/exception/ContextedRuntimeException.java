...
public class ContextedRuntimeException extends RuntimeException implements ExceptionContext {
	 ...
	 *
	 * @param cause
	 *            the underlying cause of the exception, may be null
	 */
	...
	/**
	 * Instantiates ContextedRuntimeException with cause, message, and
	 * ExceptionContext.
	 *
	 * @param message
	 *            the exception message, may be null
	 ...
	 *            the underlying cause of the exception, may be null
	 * @param context
	 *            the context used to store the additional information, null
	 ...
	 *
	 * @param label
	 *            a textual label associated with information, {@code null} not
	 *            recommended
	 * @param value
	 *            information needed to understand exception, may be
	 *            {@code null}
