...
public class ThreadUtils {
	 ...
	 *         thread's id match the specified id. {@code null} is returned if
	 *         no such thread exists
	 * @throws IllegalArgumentException
	 *             if the specified id is zero or negative or the group is null
	 * @throws SecurityException
	 *             if the current thread cannot access the system thread group
	 *
	 * @throws SecurityException
	 *             if the current thread cannot modify thread groups from this
	 *             thread's thread group up to the system thread group
	 */
	...
	/**
	 * Return the active thread with the specified id if it belong's to a thread
	 ...
	 * @throws IllegalArgumentException
	 *             if the specified id is zero or negative or the group name is
	 *             null
	 * @throws SecurityException
	 *             if the current thread cannot access the system thread group
	 *
	 ...
	 *         match the specified name, An empty collection is returned if no
	 *         such thread exists. The collection returned is always
	 *         unmodifiable.
	 * @throws IllegalArgumentException
	 *             if the specified thread name or group is null
	 * @throws SecurityException
	 *             if the current thread cannot access the system thread group
	 *
	 * @throws SecurityException
	 ...
	 *            The thread group name
	 * @return The threads which belongs to a thread group with the specified
	 *         group name and the thread's name match the specified name, An
	 *         empty collection is returned if no such thread exists. The
	 *         collection returned is always unmodifiable.
	 * @throws IllegalArgumentException
	 *             if the specified thread name or group name is null
	 * @throws SecurityException
	 *             if the current thread cannot access the system thread group
	 *
	 * @throws SecurityException
	 ...
	 *         collection if no such thread group exists. The collection
	...
	/**
	 * Return all active thread groups excluding the system thread group (A
	 * thread group is active if it has been not destroyed).
	 *
	 * @return all thread groups excluding the system thread group. The
	 *         collection returned is always unmodifiable.
	 * @throws SecurityException
	 *             if the current thread cannot access the system thread group
	 *
	...
	/**
	 * Return all active threads (A thread is active if it has been started and
	 * has not yet died).
	 *
	 * @return all active threads. The collection returned is always
	 *         unmodifiable.
	 * @throws SecurityException
	 *             if the current thread cannot access the system thread group
	 *
	 ...
	 * @param threadName
	 *            The thread name
	 * @return The threads with the specified name or an empty collection if no
	 *         such thread exists. The collection returned is always
	 *         unmodifiable.
	 * @throws IllegalArgumentException
	 ...
	 * @param threadId
	 *            The thread id
	 * @return The thread with the specified id or {@code null} if no such
	 *         thread exists
	 * @throws IllegalArgumentException
	 *             if the specified id is zero or negative
	 * @throws SecurityException
	 *             if the current thread cannot access the system thread group
	 *
	 * @throws SecurityException
	 ...
	 */
	// if java minimal version for lang becomes 1.8 extend this interface from
	...
	public static class ThreadIdPredicate implements ThreadPredicate {
		 ...
		 *
		 * @param threadId
		 *            the threadId to match
		 * @throws IllegalArgumentException
		 *             if the threadId is zero or negative
		 */
	 ...
	 *            the thread group
	 * @param recurse
	 *            if {@code true} then evaluate the predicate recursively on all
	 *            threads in all subgroups of the given group
	 * @param predicate
	 *            the predicate
	 * @return An unmodifiable {@code Collection} of active threads which match
	 *         the given predicate and which belongs to the given thread group
	 * @throws IllegalArgumentException
	 *             if the given group or predicate is null
	 * @throws SecurityException
	 *             if the current thread cannot modify thread groups from this
	 *             thread's thread group up to the system thread group
	 */
	...
	/**
	 * Select all active threadgroups which match the given predicate and which
	 * is a subgroup of the given thread group (or one of its subgroups).
	 *
	 * @param group
	 *            the thread group
	 * @param recurse
	 *            if {@code true} then evaluate the predicate recursively on all
	 *            threadgroups in all subgroups of the given group
	 * @param predicate
	 *            the predicate
	 * @return An unmodifiable {@code Collection} of active threadgroups which
	 *         match the given predicate and which is a subgroup of the given
	 *         thread group
	 * @throws IllegalArgumentException
	 *             if the given group or predicate is null
	 * @throws SecurityException
